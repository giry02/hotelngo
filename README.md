...
> **브랜드 로고 잠금:** 새 UI 작업 전에 `assets/brand/brand-config.json`과 `docs/hotelngo/13-brand-logo-style-guide.md`를 먼저 확인한다. 웹 화면은 05번 Go Capsule의 `assets/brand/official/hotelngo-logo-go-capsule.svg`를 이미지로 사용한다.
...
- Go Capsule SVG를 메인·하위 페이지 헤더에 144px로 적용하고 비교 화면 05번을 디자인 기준으로 보관
