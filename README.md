...
> **브랜드 로고 잠금:** 새 UI 작업 전에 `assets/brand/brand-config.json`과 `docs/hotelngo/13-brand-logo-style-guide.md`를 먼저 확인한다. 웹 화면은 07번 IBM Plex Sans Go Capsule의 `assets/brand/official/hotelngo-logo-go-capsule-ibm-plex.svg`를 이미지로 사용한다.
...
- IBM Plex Sans Go Capsule SVG를 메인·하위 페이지 헤더에 152px로 적용하고 07번 정본을 별도 보관
