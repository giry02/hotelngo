...
| 영역 | 메뉴/기능 |
|---|---|
| 기본 메뉴 | `여행 발견 / 여행 일정 / 호텔 / 즐길거리 / AI 여행 / 내 여행` |
| 여행 발견 | 목적지 미정 영감, 도시·테마·스토리·랜드마크·다른 여행자의 공개 일정 |
...
| 공개 일정 | `community.html`, `trip-guide-detail.html` | 여행 발견 하위에서 다른 여행자의 일정을 보고 내 여행으로 복사 |
...
- 상단 메뉴의 `여행 일정`은 공개 일정 피드가 아니라 편집기로 연결하며, 공개 일정은 `여행 발견`의 하위 기능으로 이동했다. 중복된 `현지 장소` 상단 메뉴는 제거하고 실제 업체·상품 데이터는 `즐길거리`에 흡수했다.
