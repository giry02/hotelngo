(() => {
  ...
  const logo = (_assetId, ariaLabel = 'HotelnGo Go Capsule 로고') => `
    <img class="brand-logo" src="assets/brand/official/hotelngo-logo-go-capsule.svg?v=1" width="420" height="100" alt="${ariaLabel}" decoding="async">`;
